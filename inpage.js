        ...
        class p extends u.default {
            constructor(e, {jsonRpcStreamName: t="metamask-provider", logger: r=console, maxEventListeners: n=100}={}) {
                ...
                this._jsonRpcConnection.events.on("notification", (t=>{
                    ...
                    "metamask_accountsChanged" === r ? this._handleAccountsChanged(n) : "metamask_unlockStateChanged" === r ? this._handleUnlockStateChanged(n) : "metamask_chainChanged" === r ? this._handleChainChanged(n) : h.EMITTED_NOTIFICATIONS.includes(r) ? this.emit("message", {
                        type: r,
                        data: n
            ...
            _handleDisconnect(e, t) {
                if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !e) {
                    ...
                    e ? (r = new c.EthereumRpcError(1013,t || d.default.errors.disconnected()),
                    this._log.debug(r)) : (r = new c.EthereumRpcError(1011,t || d.default.errors.permanentlyDisconnected()),
                    this._log.error(r),
                    this.chainId = null,
            ...
            _handleChainChanged({chainId: e, networkVersion: t}={}) {
                ...
                this._state.initialized && this.emit("chainChanged", this.chainId))) : this._log.error("MetaMask: Received invalid network parameters. Please report this bug.", {
                    chainId: e,
                    networkVersion: t
                })
            }
 ...
 */
    ...
    46: [function(e, t, r) {
        ...
        r.serializeError = function(e, {fallbackError: t=s, shouldIncludeStack: r=!1}={}) {
            ...
            if (e && "object" == typeof e && !Array.isArray(e) && f(e, "code") && u(e.code)) {
                const t = e;
                l.code = t.code,
                t.message && "string" == typeof t.message ? (l.message = t.message,
                f(t, "data") && (l.data = t.data)) : (l.message = a(l.code),
                l.data = {
                    originalError: c(e)
                })
            } else {
            ...
            if ("object" == typeof e && null !== e) {
                for (a = 0; a < r.length; a++)
                    if (r[a] === e) {
                        ...
                        return void (void 0 !== u.get ? u.configurable ? (Object.defineProperty(o, t, {
                            value: "[Circular]"
                        }),
                        n.push([o, t, e, u])) : i.push([e, t]) : (o[t] = "[Circular]",
                        n.push([o, t, e])))
                    }
                if (r.push(e),
                Array.isArray(e))
    ...
    48: [function(e, t, r) {
        ...
        r.write = function(e, t, r, n, i, o) {
            ...
            u /= 2),
            s + f >= c ? (a = 0,
            s = c) : s + f >= 1 ? (a = (t * u - 1) * Math.pow(2, i),
